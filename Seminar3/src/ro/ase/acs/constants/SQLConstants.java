...
public class SQLConstants {
  ...
  public static final Integer INDEX_EMPLOYEE_ID = 1;
  public static final Integer INDEX_EMPLOYEE_NAME = 2;
  public static final Integer INDEX_EMPLOYEE_ADDRESS = 3;
  public static final Integer INDEX_EMPLOYEE_SALARY = 4;

  public static final String DROP_EMPLOYEES_TABLE = "DROP TABLE IF EXISTS " + TABLE_EMPLOYEES;

  public static final String CREATE_TABLE_EMPLOYEES = "CREATE TABLE " +
      TABLE_EMPLOYEES +
      "(" +
      COLUMN_EMPLOYEE_ID +
      " INTEGER PRIMARY KEY, " +
  ...
  public static final String QUERY_EMPLOYEES_ALL = "SELECT * FROM " + TABLE_EMPLOYEES;
}
